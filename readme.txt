...
3. Search for `KeesTalksTech Post Lists` and click 'Install Now' or click on the `upload` link to upload `ktt-wp-post-lists.zip`
4. Click on `Activate plugin`

== Changelog ==

= 0.5: May 28, 2023 =
* Birthday of KeesTalksTech Post Lists